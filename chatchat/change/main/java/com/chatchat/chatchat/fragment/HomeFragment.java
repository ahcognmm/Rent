...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
        ...
        img_temp = (ImageView) getView().findViewById(R.id.img_temp_day);
        img_temp1 = (ImageView) getView().findViewById(R.id.img_temp_day1);
        img_temp2 = (ImageView) getView().findViewById(R.id.img_temp_day2);
        ...
        tv_temp_min = (TextView) getView().findViewById(R.id.text_max_temp_day);
        tv_temp_max = (TextView) getView().findViewById(R.id.text_min_temp_day);
        tv_temp_1 = (TextView) getView().findViewById(R.id.temp_day1);
        tv_temp_2 = (TextView) getView().findViewById(R.id.temp_day2);
        tv_temp_day1 = (TextView) getView().findViewById(R.id.text_temp_day1);
        tv_temp_day2 = (TextView) getView().findViewById(R.id.text_temp_day2);
...
//                    Log.e("number kq:",str);
    ...
    private boolean loadImg(String icon, ImageView img, boolean r){
        ...
        switch (icon.substring(0,icon.length() - 2)){
            case "i01": if(r) Picasso.with(context).load(R.drawable.i01d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i01d_b).into(img);
                        isRain = false;break;
            case "i02": if(r) Picasso.with(context).load(R.drawable.i02d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i02d_b).into(img);
                        isRain = false;break;
            case "i03": if(r) Picasso.with(context).load(R.drawable.i03d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i03d_b).into(img);
                        isRain = false;break;
            case "i04": if(r) Picasso.with(context).load(R.drawable.i04d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i04d_b).into(img);
                        isRain = false;break;
            case "i09": if(r) Picasso.with(context).load(R.drawable.i09d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i09d_b).into(img);
                        isRain = true;break;
            case "i10": if(r) Picasso.with(context).load(R.drawable.i10d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i10d_b).into(img);
                        isRain = true;break;
            case "i11": if(r) Picasso.with(context).load(R.drawable.i11d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i11d_b).into(img);
                        isRain = true;break;
            case "i13": if(r) Picasso.with(context).load(R.drawable.i13d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i13d_b).into(img);
                        isRain = true;break;
            case "i50": if(r) Picasso.with(context).load(R.drawable.i50d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i50d_b).into(img);
                        isRain = true;break;
            default:    if(r) Picasso.with(context).load(R.drawable.i01d_r).into(img);
                        else Picasso.with(context).load(R.drawable.i01d_b).into(img);
                        isRain = false; break;
        }
        return isRain;
