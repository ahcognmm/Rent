...
public class LinksFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvLinks = (TextView) getView().findViewById(R.id.tvLinks);

        lvHotelLinks = (ListView) getView().findViewById(R.id.lvHotelLinks);

        linkList = new ArrayList<>();
        linkAdapter = new LinkAdapter(context,R.layout.hotel_links,linkList);
        lvHotelLinks.setAdapter(linkAdapter);
...
//
    public LinksFragment(Context context, Hotel hotel) {
